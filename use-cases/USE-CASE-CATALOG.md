...
Supporting documents: [PHILOSOPHY.md](PHILOSOPHY.md) (design principles), [SHARED-INVARIANTS.md](SHARED-INVARIANTS.md) (cross-cutting rules), [TEMPLATE.md](TEMPLATE.md) (use case structure), [DOMAIN-EVENTS.md](domains/DOMAIN-EVENTS.md) (event catalog).
