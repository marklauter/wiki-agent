...
- **Creator assignment** -- step 10, input to each creator. Contains: page file path, title, description, key source files to read, audience, tone, and editorial guidance. One assignment per creator.
